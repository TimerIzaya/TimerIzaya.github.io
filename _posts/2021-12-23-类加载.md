...
![image-20211224171413513](https://gitee.com/timerizaya/timer-pic/raw/master/img/image-20211224171413513.png)
...
1. #### 加载
   ...
   把类的字节码载入方法区，元空间创建对应的instanceClass，堆中生成对应的Class对象。
